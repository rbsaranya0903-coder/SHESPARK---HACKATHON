...
export default function Onboarding() {
  ...
  useEffect(() => {
    ...
    axios.get(`${API_URL}/onboarding/${user?.id}`).then(res => {
      if (res.data.profile) {
        ...
        setCurrentStep(p.onboarding_step || 6);
        setFormData(prev => ({
          ...prev,
  ...
  if (isAnalyzingTwin) {
    ...
    return (
      <div className="min-h-screen bg-[#0a0604] text-stone-300 font-sans flex flex-col justify-between overflow-hidden relative selection:bg-orange-500/30">
        ...
        {/* Top Navbar Header */}
        <header className="relative z-10 py-6 border-b border-orange-900/20 bg-black/40 backdrop-blur-md flex justify-center items-center">
          <div className="flex items-center gap-2 text-stone-300 font-medium text-sm hover:text-white cursor-pointer transition-colors bg-white/[0.02] border border-orange-900/30 px-4 py-2 rounded-xl">
        ...
        <main className="relative z-10 max-w-xl mx-auto w-full px-6 py-12 text-center my-auto">
          ...
          <div className="relative w-36 h-36 mx-auto mb-8 flex items-center justify-center">
            ...
            <div className="absolute flex flex-col items-center justify-center">
              ...
              <span className="text-xl font-bold font-mono text-stone-100">{progressPercent}%</span>
            </div>
          </div>

          {/* Heading & Subtitle */}
          <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-3 tracking-tight">
            Building Your Brand Digital Twin
          </h1>
          <p className="text-stone-400 text-sm lg:text-base font-light mb-10 max-w-md mx-auto leading-relaxed">
                ...
                <div
                  ...
                  className={`p-4 rounded-2xl border transition-all duration-500 flex items-center gap-3.5 ${
                    isDone
                      ...
                      : 'bg-black/30 border-orange-900/20 text-stone-600'
                  }`}
                >
                  <div
        ...
        {/* Footer */}
        <footer className="relative z-10 py-6 text-center text-xs font-mono text-stone-700 border-t border-orange-900/20">
  ...
  return (
    <div className="min-h-screen bg-[#0a0604] text-stone-300 font-sans flex overflow-hidden relative selection:bg-orange-500/30">
      ...
      <div className="w-80 lg:w-96 relative z-10 bg-[#0a0604]/70 backdrop-blur-2xl border-r border-orange-900/20 p-8 lg:p-10 flex flex-col justify-between shrink-0">
        <div>
          {/* Logo Header */}
          <div className="flex items-center gap-3 mb-10 cursor-pointer" onClick={() => navigate('/')}>
            <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-amber-600 flex items-center justify-center rounded-xl font-bold text-white shadow-[0_0_20px_rgba(249,115,22,0.4)]">
              ...
              return (
                ...
                >
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-xs z-10 shrink-0 transition-all duration-500 ${
                    ...
                    isCurrent ? 'bg-gradient-to-r from-orange-400 to-amber-500 text-[#0a0604] shadow-[0_0_20px_rgba(249,115,22,0.6)] scale-110 border-2 border-orange-200/50' : 'bg-[#0a0604] border border-orange-900/40 text-stone-600 group-hover:border-orange-500/40'
                  }`}>
                    {isCompleted ? <Check size={16} /> : step.id}
                  </div>
                  <div className="flex-1 pt-1">
                    <div className={`font-bold text-sm transition-colors duration-300 ${isCurrent ? 'text-orange-400' : isCompleted ? 'text-stone-200' : 'text-stone-500'}`}>
                      {step.title}
                    </div>
                    <div className={`text-xs mt-0.5 transition-colors duration-300 font-light ${isCurrent || isCompleted ? 'text-stone-400' : 'text-stone-700'}`}>{step.desc}</div>
                  </div>
                </div>
              );
            })}
        ...
        <div className="pt-8 border-t border-orange-900/20">
          ...
          <div className="w-full h-1.5 bg-stone-900 rounded-full overflow-hidden border border-orange-900/20">
            <div 
      ...
      {/* Right Content Area */}
      <div className="flex-1 p-8 lg:p-14 overflow-y-auto relative z-10 flex flex-col justify-between">
        <div className="max-w-2xl mx-auto w-full my-auto">
          ...
          {currentStep === 1 && (
            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-2 tracking-tight">Company Profile</h1>
              <p className="text-stone-400 mb-8 text-base font-light">Tell us about your organization</p>
              
              <div className="space-y-6">
                <div className="group">
                  <label className="block text-sm font-semibold text-stone-300 mb-2 group-focus-within:text-orange-400 transition-colors">
                    Company Name
                  </label>
                  <input 
                    type="text" 
                    ...
                    className="w-full bg-black/40 px-4 py-3.5 rounded-xl border border-orange-900/30 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none text-stone-200 text-base transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] placeholder:text-stone-700" 
                ...
                <div className="group">
                  ...
                  <select 
                    ...
                    className="w-full bg-black/40 px-4 py-3.5 rounded-xl border border-orange-900/30 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none text-stone-200 text-base transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] cursor-pointer"
                  >
                    {INDUSTRIES.map(ind => (
                      <option key={ind} value={ind} className="bg-stone-900 text-stone-200">
                        {ind}
                      </option>
                    ))}
                  </select>
                ...
                <div className="group">
                  ...
                  <textarea 
                    ...
                    className="w-full bg-black/40 px-4 py-3.5 rounded-xl border border-orange-900/30 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none text-stone-200 text-base h-28 resize-none transition-all shadow-[inset_0_2px_10px_rgba(0,0,0,0.5)] placeholder:text-stone-700" 
          ...
          {currentStep === 2 && (
            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-2 tracking-tight">Brand Identity</h1>
              <p className="text-stone-400 mb-8 text-base font-light">Upload your brand assets</p>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div 
                    ...
                    className="border-2 border-dashed border-orange-900/40 rounded-2xl p-8 text-center bg-black/30 hover:border-orange-500/60 transition-all cursor-pointer group shadow-[inset_0_2px_15px_rgba(0,0,0,0.4)]"
                  >
                    ...
                    <p className="text-base text-stone-200 font-semibold mb-1">
                    ...
                    <button 
                      type="button"
                      className="bg-stone-900 hover:bg-stone-800 border border-orange-900/30 text-stone-200 px-6 py-2 rounded-xl text-xs font-semibold tracking-wide transition-colors"
                    >
                      Browse files
                    </button>
                  </div>
                ...
                {/* Brand Colors */}
                <div>
                  <label className="block text-sm font-semibold text-stone-300 mb-4">
                    Brand Colors
                  </label>
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs text-stone-400 font-medium mt-2">Primary</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs text-stone-400 font-medium mt-2">Secondary</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs text-stone-400 font-medium mt-2">Accent</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <span className="text-xs text-stone-400 font-medium mt-2">Neutral</span>
                    </div>
                  </div>
                </div>
                    ...
                    <div 
                      ...
                      className={`p-4 rounded-xl border cursor-pointer transition-all ${
                        formData.typography === 'Inter — Primary'
                          ...
                          : 'border-orange-900/30 bg-black/40 text-stone-400 hover:border-orange-500/30'
                      }`}
                    >
          ...
          {currentStep === 3 && (
            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-2 tracking-tight">Brand Voice</h1>
              <p className="text-stone-400 mb-8 text-base font-light">Define your communication style</p>
                        ...
                        <div
                          ...
                          className={`py-3.5 px-4 rounded-xl border text-center cursor-pointer transition-all text-sm font-medium ${
                            isSelected
                              ...
                              : 'border-orange-900/30 bg-black/40 text-stone-400 hover:border-orange-500/40 hover:text-stone-200'
                          }`}
                        >
                          {trait}
                        </div>
          ...
          {currentStep === 4 && (
            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-2 tracking-tight">Target Audience</h1>
              <p className="text-stone-400 mb-8 text-base font-light">Who are your customers?</p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="group">
                      <label className="block text-xs font-mono text-stone-400 mb-1.5">Age Range</label>
                      <input 
                        type="text" 
                        value={formData.age_range} 
                        onChange={e => updateForm('age_range', e.target.value)} 
                        placeholder="Enter age range" 
                        className="w-full bg-black/40 px-4 py-3 rounded-xl border border-orange-900/30 focus:border-orange-500 outline-none text-stone-200 text-sm placeholder:text-stone-700" 
                      />
                    </div>

                    <div className="group">
                      <label className="block text-xs font-mono text-stone-400 mb-1.5">Location</label>
                      <input 
                        type="text" 
                    ...
                    <div className="group">
                      <label className="block text-xs font-mono text-stone-400 mb-1.5">Income Level</label>
                      <input 
                        type="text" 
                    ...
                    <div className="group">
                      <label className="block text-xs font-mono text-stone-400 mb-1.5">Industry Sector</label>
                      <select 
                        value={formData.audience_industry} 
                        onChange={e => updateForm('audience_industry', e.target.value)} 
                        className="w-full bg-black/40 px-4 py-3 rounded-xl border border-orange-900/30 focus:border-orange-500 outline-none text-stone-200 text-sm cursor-pointer"
                      >
                        {INDUSTRIES.map(ind => (
                          <option key={ind} value={ind} className="bg-stone-900 text-stone-200">
                            {ind}
          ...
          {currentStep === 5 && (
            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-2 tracking-tight">Digital Presence</h1>
              <p className="text-stone-400 mb-8 text-base font-light">Connect your channels</p>
          ...
          {currentStep === 6 && (
            <div className="animate-in fade-in slide-in-from-bottom-6 duration-500">
              <h1 className="text-3xl lg:text-4xl font-extrabold text-stone-100 mb-2 tracking-tight">Competitors</h1>
              <p className="text-stone-400 mb-8 text-base font-light">Monitor your competition</p>
              ...
              <div className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full border border-dashed border-orange-900/40 hover:border-orange-500/50 rounded-xl p-4 text-center text-stone-400 hover:text-orange-300 transition-colors text-sm font-medium flex items-center justify-center gap-2 bg-black/20"
                >
          ...
          {/* Footer Controls */}
          <div className="mt-12 flex justify-between items-center border-t border-orange-900/20 pt-6">
            <button 
              onClick={() => setCurrentStep(prev => Math.max(1, prev - 1))}
              disabled={currentStep === 1 || loading}
              className="px-6 py-2.5 rounded-xl border border-orange-900/30 bg-black/40 text-stone-400 hover:text-stone-200 font-medium text-sm transition-all disabled:opacity-0 flex items-center gap-1.5"
            >
